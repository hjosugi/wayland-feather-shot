...
JA = {
    ...
    "GIF capture — Feather Shot": "GIFキャプチャ — Feather Shot",
    "Choose the area to record…": "録画する範囲を選んでください…",
    "Drag to select the area, then press Enter.":
        "範囲をドラッグで選び、Enter を押してください。",
    "Start recording": "録画開始",
    "Stop && save": "停止して保存",
    "Recording…  frames: {n}": "録画中…  フレーム: {n}",
    "Not enough frames captured.": "フレームが足りません。",
    "GIF capture failed: {error}": "GIFキャプチャに失敗しました: {error}",
    ...
    "Auto": "自動",
    "Align": "配置",
    "Border around the screenshot": "スクリーンショットに枠線",
    "Watermark": "透かし",
    "Watermark text": "透かしの文字",
    "Repeat": "繰り返し",
    "0 places one mark in the corner; higher tiles it": "0で隅に1つ、大きくすると敷き詰めます",
